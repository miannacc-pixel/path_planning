...
// [Same as in previous code, included below for completeness]
...
int main()
{
    ...
    if (solved)
    {
        ...
        std::string path_filename = "path_data_prm.csv";
        ...
        std::cout << "Path data saved to '" << path_filename << "'. Run the provided Python script to plot the path." << std::endl;
    }
    else
    {
